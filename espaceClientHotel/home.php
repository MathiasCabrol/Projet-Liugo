                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <div class="col-12 text-center my-5 text-black">
                                    <h2 class="tangerine hotelSub">Bienvenue à l'Hôtel du Cap-Ferret<sup>****</sup></h2>
                                    <img class="primaryModalImage mt-5" src="../assets/img/hotel-webFormat.jpg">
                                    <p class="mt-5">Dans ce lieu de relaxation pensé et étudié pour une clientèle exigeante. Nous faisons honneur à un cadre somptueux tout en conservant un sens aïgue du service et de l'hospitalité.</p>
                                    <div class="row justify-content-start">
                                        <div class="col-10">
                                            <p class="mt-5 modalSmallp">Découvrez les activités proposées par nos partenaires</p>
                                            <img class="secondaryModalImage" src="../assets/img/hiker-g2509bd607_640.jpg">
                                    ...
                                    <div class="row justify-content-end">
                                        <div class="col-10">
                                            ...
                                            <img class="secondaryModalImage" src="../assets/img/chef-g4f86bc479_640.jpg">
